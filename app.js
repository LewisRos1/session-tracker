...
function renderTargetManageContent(student, target) {
  ...
  // Read all current option inputs for a given activity idx
  ...
  // Wire a del button (used for both initial and dynamically added rows)
  ...
  // Wire a blur handler (used for both initial and dynamically added inputs)
